        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="header-title mt-3"> Service List</h4>
                        </div>
                        <div class="col-4">
                            <div class="pull-right">
                                <a class="btn btn-outline-primary btn-sm mb-3" href="/service/create"><i
                                        class="ti-plus">&nbsp; New Service</i></a>
                                @if (session('status'))
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class=>
                                        ...
                                        <!-- <a href="/services/{{ $service->id }}/edit" class="btn btn-rounded btn-warning btn-xs " ><i class="ti-pencil-alt"><span>&nbsp;Edit</span></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
