                                            ...
                                            <div class="row  mt-2">
                                                ...
                                                <div class="col-xs-4 col-md-9">
                                                    <input type="text" name="resource"
                                                        ...
                                                        id="resource" value="{{ old('resource')}}">
                                                    @error ('resource')
                                            ...
                                            <div class="row  mt-2">
                                                ...
                                                <div class="col-xs-4 col-md-9">
                                                    <textarea name="headline"
                                                        ...
                                                        id="headline" value="{{ old('headline')}}">
                                                    </textarea>
                                                    @error ('headline')
                                            ...
                                            <div class="row  mt-2">
                                                ...
                                                <div class="col-xs-4 col-md-9">
                                                    <input type="file" name="headline_img"
                                                        ...
                                                        id="headline_img" value="{{ old('headline_img')}}">
                                                    @error ('headline_img')
                                            ...
                                            <div class="row  mt-2">
                                                ...
                                                <div class="col-xs-4 col-md-9">
                                                    <textarea name="firstparagraph"
                                                        ...
                                                        id="firstparagraph" value="{{ old('firstparagraph')}}">
                                                    </textarea>
                                            ...
                                            <div class="row  mt-2">
                                                ...
                                                <div class="col-xs-4 col-md-9">
                                                    <input type="file" name="firstparagraph_img"
                                                        ...
                                                        id="firstparagraph_img" value="{{ old('firstparagraph_img')}}">
                                            ...
                                            <div class="row  mt-2">
                                                ...
                                                <div class="col-xs-4 col-md-9">
                                                    <textarea name="secondparagraph"
                                                        ...
                                                        id="secondparagraph" value="{{ old('secondparagraph')}}">
                                                    </textarea>
                                            ...
                                            <div class="row  mt-2">
                                                ...
                                                <div class="col-xs-4 col-md-9">
                                                    <textarea name="thirdparagraph"
                                                        ...
                                                        id="thirdparagraph" value="{{ old('thirdparagraph')}}">
                                                    </textarea>
                                            ...
                                            <div class="row  mt-2">
                                                ...
                                                <div class="col-xs-4 col-md-9">
                                                    <input type="file" name="thirdparagraph_img"
                                                        ...
                                                        id="thirdparagraph_img" value="{{ old('thirdparagraph_img')}}">
                                            ...
                                            <div class="row  mt-2">
                                                ...
                                                <div class="col-xs-4 col-md-9">
                                                    <textarea name="fourthparagraph"
                                                        ...
                                                        id="fourthparagraph" value="{{ old('fourthparagraph')}}">
                                                    </textarea>
                                            ...
                                            <div class="row  mt-2">
                                                ...
                                                <div class="col-xs-4 col-md-9">
                                                    <textarea name="footline"
                                                        ...
                                                        id="footline" value="{{ old('footline')}}">
                                                    </textarea>
                                                    @error ('footline')
                                                    <div class="alert alert-danger invalid-feedback">Mohon
